...
export const MANIFOLD_USER_USERNAME = 'MEXAS'
export const MANIFOLD_USER_NAME = 'MEXAS'
export const MANIFOLD_AVATAR_URL = '/logo.png'
export const MANIFOLD_LOVE_LOGO = '/logo.png'
